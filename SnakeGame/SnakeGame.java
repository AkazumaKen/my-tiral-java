...
public class SnakeGame extends JPanel implements ActionListener, KeyListener {
    ...
    public void draw(Graphics g) {
        ...
        if (gameOver) {
            g.setColor(Color.red);
            g.drawString("BOGOA NIMO OYYY AMAW",150,300);
            g.drawString("Imong score ah: " + String.valueOf(snakeBody.size()),175,330);
        }
        else {
            g.drawString("Puntos: " + String.valueOf(snakeBody.size()), tileSize - 16, tileSize);
        }
    }
